    ...
    <div class="card card-body bg-light mt-5">
      ...
      <form action="<?php echo URLROOT; ?>/users/register" method="post">
        <div class="form-group">
          ...
          <span class="text-danger"><small><?php echo $data['name_err']; ?></small></span>
        </div>
        <div class="form-group">
          ...
          <span class="text-danger"><small><?php echo $data['email_err']; ?></small></span>
        </div>
        <div class="form-group">
          ...
          <span class="text-danger"><small><?php echo $data['password_err']; ?></small></span>
        </div>
        <div class="form-group">
          ...
          <span class="text-danger"><small><?php echo $data['confirm_password_err']; ?></small></span>
        </div>
